  ...
  categories: [
    {
      ...
      items: [
        { src: "/community-outreach/back-to-school-2.webp", alt: "Back to School project", label: "Back to School" },
        { src: "/community-outreach/back-to-school-3.webp", alt: "Back 2 School project", label: "Back to School" },
        { src: "/community-outreach/back-to-school-4.webp", alt: "Back to School project event", label: "Back to School" },
        { src: "/community-outreach/back-to-school-5.webp", alt: "Back to School project photo", label: "Back to School" },
        { src: "/community-outreach/pwd-group.webp", alt: "Leading a PWD group", label: "PWD Group" },
        { src: "/community-outreach/pwd-campaign.webp", alt: "PWD campaign", label: "PWD Campaign" },
        { src: "/community-outreach/pwd-gift-giving.webp", alt: "PWD gift giving event", label: "PWD Gift Giving" },
        { src: "/community-outreach/pandemic-gift-giving.webp", alt: "Pandemic gift giving outreach", label: "Pandemic Relief" },
        { src: "/community-outreach/community-1.webp", alt: "Community outreach event", label: "Outreach" },
        { src: "/community-outreach/community-2.webp", alt: "Community outreach event", label: "Outreach" },
        { src: "/community-outreach/community-3.webp", alt: "Community outreach event", label: "Outreach" },
        { src: "/community-outreach/community-4.webp", alt: "Community outreach event", label: "Outreach" },
        { src: "/community-outreach/community-5.webp", alt: "Community outreach event", label: "Outreach" },
        { src: "/community-outreach/community-6.webp", alt: "Community outreach event", label: "Outreach" },
      ],
    },
    {
      name: "Travel Photos",
    ...
    },
    {
      ...
      items: [
        ...
        { src: "/events/australia-awards-speaker.jpg", alt: "Speaking at Australia Awards", label: "Awards Speaker" },
        { src: "/events/australia-awards.jpg", alt: "Australia Awards", label: "Australia Awards" },
        { src: "/events/content-accessibility-campaign.jpg", alt: "Content Accessibility Campaign", label: "Accessibility Campaign" },
        { src: "/events/data-7.jpg", alt: "Data event photo", label: "Data Event" },
        { src: "/events/data-8.jpg", alt: "Data event photo", label: "Data Event" },
        { src: "/events/data-11.jpg", alt: "Data event photo", label: "Data Event" },
        { src: "/events/gedsi-hosting.jpg", alt: "GEDSI event hosting", label: "GEDSI Hosting" },
        ...
        { src: "/events/singapore-2.jpg", alt: "Singapore trip", label: "Singapore" },
      ],
    },
  ] as GalleryCategory[],
};
